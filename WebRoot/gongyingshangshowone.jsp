...
<body>
<span class="STYLE4">当前页为：显示供应商详细信息页</span>
			...
			<TD width="100%" height="300">
				...
				<legend>供应商信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%"><textarea name="gongname" cols="30" rows="1" id="gonggname">${gys.gonggname }</textarea>
						...
						<tr>	
							...
							<td width="35%" class="STYLE4"><input name='lianphone' type="text" id="yinhangid" value="${gys.yinhangid }" class="text"style="width:154px"  />
							<span id="yinglianxi1" class="STYLE4"></span>
							</td>
						</tr>
					  </table>

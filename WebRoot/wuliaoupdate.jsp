...
<body>
<span class="STYLE4">当前页为：修改物料信息页</span>
  <form action="wuliao!update.action" method="post" >
			...
			<TD width="100%" height="300">
				...
				<legend>物料信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%">
					    <input name='wuliao.wuliaoid' type="text"  class="text"style="width:154px" value="${wuliao.wuliaoid }" />
				        </td>
				        	
					    <td nowrap align="right" width="18%" class="STYLE4">物料名称:</td>
					    <td width="35%"><textarea name="wuliao.wuliaoname" cols="30" rows="1" id="yingname">${wuliao.wuliaoname }</textarea>
					    <span id="yingname1" class="STYLE4"></span>
					    </td>
						<tr>	
							<td nowrap align="right" width="15%" class="STYLE4">规格:</td>
					        <td width="35%" class="STYLE4"><input name='wuliao.guige' type="text" value="${wuliao.guige }" class="text"style="width:154px"  />
					        <span id="yingfuname1" class="STYLE4"></span>
					        </td>
						    <td nowrap align="right" width="18%" class="STYLE4">物料类型:</td>
							<td width="35%" class="STYLE4"><input name='wuliao.leixing' type="text" value="${wuliao.leixing }" class="text"style="width:154px"  />
							<span id="yinglianxi1" class="STYLE4"></span>
							</td>
						</tr>
						<tr>
						  <td height="23" align="right" nowrap class="STYLE4">有效期:</td>
						  <td><span class="STYLE4">
						    <input name='wuliao.youxiaoqi' type="text" value="${wuliao.youxiaoqi }"  class="text"style="width:154px" />
						  </span>

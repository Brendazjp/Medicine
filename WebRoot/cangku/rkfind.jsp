...
<body>
<span class="STYLE4">当前页为：查询入库基本信息页</span>
  <form action="ruku!find.action" method="post">
			...
			<TD width="100%" height="300">
				...
				<legend>入库基本信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%">
					     <input name='ruku.rkid' type="text" class="text"  style="width:154px" />
				        </td>
					  </tr>
						<tr>
					    <td width="15%" height="35" align="right" nowrap class="STYLE4">产品名称:</td>
					    <td width="35%">
					    <input name='ruku.channame' type="text" class="text" style="width:154px" />
					    </td>
				         <td nowrap align="right" width="18%" class="STYLE4">仓库名称:</td>
					     <td width="35%">
					     <select name="ruku.ckname">
						...
						<tr>
						  ...
						  <td><input name='ruku.rktime' type="text" onclick="WdatePicker()" style="width:154px" /></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>

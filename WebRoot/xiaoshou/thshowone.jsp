...
<body>
<span class="STYLE4">当前页为：退货详细信息页</span>
				...
				<legend>退货信息</legend>
					  ...
					  <tr>	
					    ...
					    <tr>
							  ...
							  <td><input name='xiaoshou.thtime' type="text" readonly="readonly"  style="width:154px" value="${xiaoshou.thtime }"/></td>
							  <td nowrap="nowrap" align="right" class="STYLE4">退货详情（原因，数量，解决办法）：</td>
							  <td><textarea name="xiaoshou.thyanyin" readonly="readonly" cols="45" rows="6" id="textare">${xiaoshou.thyanyin }</textarea></td> 
					    </tr>
					  </table>
				</fieldset>			
			</TD>

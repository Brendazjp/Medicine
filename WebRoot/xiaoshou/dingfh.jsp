...
<body>
<span class="STYLE4">当前页为：添加发货信息页</span>
<form action="xiaoshou!update.action" method="post">
				...
				<legend>订单信息</legend>
					  ...
					  <tr>	
					    ...
					    <tr>
							  ...
							  <td><input name='xiaoshou.zhuangtai' type="hidden"  readonly="readonly" style="width:154px" value="发货"/></td>
					    </tr>
					    <tr>
							  <td height="17" align="right" class="STYLE4">发货时间:</td>
							  <td><input name='xiaoshou.fatime' type="text" onclick="WdatePicker()" style="width:154px"/></td>
							  <td nowrap="nowrap" align="right" class="STYLE4">物流公司</td>
							  <td><input name='xiaoshou.wuliu' type="text" class="text"  style="width:154px"/></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>

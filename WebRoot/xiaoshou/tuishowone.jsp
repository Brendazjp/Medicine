...
<body>
<span class="STYLE4">当前页为：退单详细信息页</span>
					  ...
					  <tr>
					   ...
					   <tr>	
					    ...
					    <tr>
							  ...
							  <td><input name='xiaoshou.zhuangtai' type="hidden"  readonly="readonly" style="width:154px" value="退单"/></td>
					    </tr>
					    <tr>
							  <td height="17" align="right" class="STYLE4">退单时间:</td>
							  <td><input name='xiaoshou.tdtime' type="text" style="width:154px" value="${xiaoshou.tdtime }"/></td>
							  <td nowrap="nowrap" align="right" class="STYLE4">退单原因及处里方法</td>
							  <td><textarea name="xiaoshou.tdyanyin" cols="45" rows="6">${xiaoshou.tdyanyin}</textarea></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>

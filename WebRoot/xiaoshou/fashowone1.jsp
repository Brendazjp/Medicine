...
<body>
<span class="STYLE4">当前页为：修改发货信息页</span>
				...
				<legend>发货信息</legend>
					  ...
					  <tr>	
					    ...
					    <tr>
							  ...
							  <td><input name='xiaoshou.fatime' type="text" onclick="WdatePicker()" style="width:154px" value="${xiaoshou.fatime }"/></td>
							  <td nowrap="nowrap" align="right" class="STYLE4">物流公司</td>
							  <td><input name='xiaoshou.wuliu' type="text" class="text"  style="width:154px" value="${xiaoshou.wuliu }"/></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>

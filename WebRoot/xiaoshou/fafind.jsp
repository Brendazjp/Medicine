...
<body>
<span class="STYLE4">当前页为：查询发货信息页</span>
<form action="fahuo!find.action" method="post">
					  ...
					  <tr>
					   ...
					   <tr>	
					    ...
					    <tr>
							  ...
							  <td><input name='xiaoshou.zhuangtai' type="hidden"  style="width:154px" value="发货"/></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>

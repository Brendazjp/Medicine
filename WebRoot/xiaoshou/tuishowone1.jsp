...
<body>
<span class="STYLE4">当前页为：修改退单信息页</span>
<form action="tuidan!update.action" method="post">
				...
				<legend>退单信息</legend>
					  ...
					  <tr>
					   ...
					   <tr>	
					    ...
					    <tr>
							  <td height="17" align="right" class="STYLE4">退单时间:</td>
							  <td><input name='xiaoshou.tdtime' type="text" onclick="WdatePicker()" style="width:154px" value="${xiaoshou.tdtime }"/></td>
							  <td nowrap="nowrap" align="right" class="STYLE4">退单原因及处里方法</td>
							  <td><textarea name="xiaoshou.tdyanyin" cols="45" rows="6" id="textare">${xiaoshou.tdyanyin }</textarea></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>

...
<body>
<span class="STYLE4">当前页为：修改退货信息页</span>
<form action="tuihuo!update.action" method="post">
				...
				<legend>退货信息</legend>
					  ...
					  <tr>	
					    ...
					    <tr>
							  ...
							  <td><input name='xiaoshou.thtime' type="text" onclick="WdatePicker()" style="width:154px" value="${xiaoshou.thtime }"/></td>
							  <td nowrap="nowrap" align="right" class="STYLE4">退货详情（原因，数量，解决办法）：</td>
							  <td><textarea name="xiaoshou.thyanyin" cols="45" rows="6" id="textare">${xiaoshou.thyanyin }</textarea></td> 
					    </tr>
					  </table>
				</fieldset>			
			</TD>

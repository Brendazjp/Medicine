...
<body>
<span class="STYLE4">当前页为：添加物料信息页</span>
  <form action="wuliao!save.action" method="post" >
			...
			<TD width="100%" height="300">
				...
				<legend>物料信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%">
					    <input name='wuliao.wuliaoid' type="text"  class="text"style="width:154px"  />
				        </td>
				        	
					    <td nowrap align="right" width="18%" class="STYLE4">物料名称:</td>
					    <td width="35%"><textarea name="wuliao.wuliaoname" cols="30" rows="1" id="yingname"></textarea>
					    <span id="yingname1" class="STYLE4"></span>
					    </td>
						<tr>	
							<td nowrap align="right" width="15%" class="STYLE4">规格:</td>
					        <td width="35%" class="STYLE4"><input name='wuliao.guige' type="text" id="yingfuname" class="text"style="width:154px"  />
					        <span id="yingfuname1" class="STYLE4"></span>
					        </td>
						    <td nowrap align="right" width="18%" class="STYLE4">物料类型:</td>
							<td width="35%" class="STYLE4"><input name='wuliao.leixing' type="text" id="yinglianxi" class="text"style="width:154px"  />
						...
						<tr>
						  ...
						  <td><span class="STYLE4">
						    <input name='wuliao.youxiaoqi' type="text" id="yingrenshu"  class="text"style="width:154px" />
						  </span>

...
<body>
<span class="STYLE4">当前页为：修改采购单信息页</span>
  <form action="caigou!update.action" method="post" >
				...
				<legend>采购单信息</legend>
					  ...
					  <tr>
						...
						<tr>	
							...
							<td width="35%" class="STYLE4"><input id="yingtime" name='caigou.caitime' type="text" onClick="WdatePicker()" style="width:154px" value="${caigou.caitime }" />

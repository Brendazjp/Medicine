...
<body>
<span class="STYLE4">当前页为：修改生产单信息页</span>
  <form action="shengchan!update.action" method="post" onsubmit="return on_submit();">
			...
			<TD width="100%" height="300">
				...
				<legend>生产单信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%">
					    <input name='shengid' type="text" class="text"style="width:154px" value="${sc.shengid }" />
				        </td>
				        	
					    <td nowrap align="right" width="18%" class="STYLE4">产品编号:</td>
					    <td width="35%"><textarea name="chanid" cols="30" rows="1" id="yingname">${sc.chanid}</textarea>
					    <span id="yingname1" class="STYLE4"></span>
					    </td>
					    </tr>
						<tr>
					    <td nowrap align="right" width="18%" class="STYLE4">生产开始时间:</td>
					     <td width="35%" class="STYLE4"><input id="katime" name='kaitime' type="text" onClick="WdatePicker()" style="width:154px" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${sc.katime}"/>"/>
					     <span id="yingtime1" class="STYLE4"></span>
					     </td>	
					     <td nowrap align="right" width="15%" class="STYLE4">交货时间:</td>
					        <td width="35%" class="STYLE4"><input name='jiaotime' type="text" onClick="WdatePicker()" class="text"style="width:154px"  value="<fmt:formatDate pattern="yyyy-MM-dd" value="${sc.jiaotime}"/>"/>
						...
						<tr>	
							...
							<td width="35%" class="STYLE4"><input name='shouliang' type="text" id="yinglianxi" class="text"style="width:154px"  value="${sc.shouliang }"/>
							<span id="yinglianxi1" class="STYLE4"></span>
							</td>
							<td height="23" align="right" nowrap class="STYLE4">生产车间:</td>
						  <td><span class="STYLE4">
						    <input name='chejian' type="text" id="yingrenshu"  class="text"style="width:154px" value="${sc.chejian }"/>
						  </span>

...
<body>
<span class="STYLE4">当前页为：显示生产单详细信息页</span>
				...
				<legend>生产单信息</legend>
					  ...
					  <tr>
					    ...
					    <td nowrap align="right" width="18%" class="STYLE4">生产开始时间:</td>
					     <td width="35%" class="STYLE4"><input id="yingtime" name='katime' type="text"  style="width:154px" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${sc.katime}"/>"/>
					     <span id="yingtime1" class="STYLE4"></span>
					     </td>	
					     <td nowrap align="right" width="15%" class="STYLE4">交货时间:</td>
					        <td width="35%" class="STYLE4"><input name='jiaotime' type="text" id="yingfuname" class="text"style="width:154px"  value="<fmt:formatDate pattern="yyyy-MM-dd" value="${sc.jiaotime}"/>"/>

...
<body>
<span class="STYLE4">当前页为：修改客户回访信息页</span>
  <form action="huifang!update.action" method="post">
			...
			<TD width="100%" height="300">
				...
				<legend>客户投诉信息</legend>
					...
					<td width="35%"><input name='fuwu.fuwuid' type="text" readonly="readonly" class="text" style="width:154px" value="${fuwu.fuwuid}"/></td>
					    ...
					    <td width="35%"><input name='fuwu.futime' type="text" onClick="WdatePicker()" style="width:154px" value="${fuwu.futime }"/></td>
				         <td nowrap align="right" width="18%" class="STYLE4">记录人姓名:</td>
					     <td width="35%"><input name='fuwu.jiluren' type="text" class="text" style="width:154px"  value="${fuwu.jiluren }"/></td>
						</tr>
						<tr>
						  <td height="17" align="right" nowrap class="STYLE4">回访内容:</td>
						  <td><textarea name="fuwu.neirong" cols="45" rows="6" id="textare">${fuwu.neirong }</textarea></td>
						  <td nowrap="nowrap" align="right" class="STYLE4">回访处理:</td>
						  <td><textarea name="fuwu.fangfa" cols="45" rows="6" id="textare">${fuwu.fangfa }</textarea></td>
					    </tr>
						<tr>
						  <td height="111" align="right" nowrap class="STYLE4">处理结果:</td>
						  <td><textarea name="fuwu.jieguo" cols="45" rows="6" id="textare">${fuwu.jieguo }</textarea></td>
						  <td nowrap="nowrap" align="right" class="STYLE4">备注:</td>
						  <td><textarea name="fuwu.beizhu" cols="45" rows="6" id="textare">${fuwu.beizhu }</textarea></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>

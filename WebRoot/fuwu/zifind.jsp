...
<body>
<span class="STYLE4">当前页为：查询客户咨询信息页</span>
  <form action="zixun!find.action" method="post">
			...
			<TD width="100%" height="300">
				...
				<legend>客户咨询信息</legend>
				      ...
				      <tr>	
						...
						<input name='fuwu.fuleibei' type="hidden" class="text" style="width:154px" value="1" />
					  </table>
				</fieldset>			
			</TD>
		</TR>		

...
<body>
<span class="STYLE4">当前页为：查询客户回访信息页</span>
  <form action="huifang!find.action" method="post">
			...
			<TD width="100%" height="300">
				...
				<legend>客户回访信息</legend>
				      ...
				      <tr>	
						...
						<input name='fuwu.fuleibei' type="hidden" class="text" style="width:154px" value="2" />
					  </table>
				</fieldset>			
			</TD>
		</TR>		

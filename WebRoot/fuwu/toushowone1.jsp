...
<body>
<span class="STYLE4">当前页为：修改客户投诉信息页</span>
  <form action="tousu!update.action" method="post">
			...
			<TD width="100%" height="300">
				...
				<legend>客户投诉信息</legend>
					...
					<td width="35%"><input name='fuwu.fuwuid' type="text" readonly="readonly" class="text" style="width:154px" value="${fuwu.fuwuid}"/></td>
						...
						<tr>
						  <td height="17" align="right" nowrap class="STYLE4">投诉内容:</td>
						  <td><textarea name="fuwu.neirong" cols="45" rows="6" id="textare">${fuwu.neirong }</textarea></td>
						  <td nowrap="nowrap" align="right" class="STYLE4">投诉处理:</td>

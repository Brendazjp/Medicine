...
<body>
<span class="STYLE4">当前页为：添加供应商信息页</span>
  <form action="gongYingShang!add.action" method="post" onsubmit="return on_submit();">
			...
			<TD width="100%" height="300">
				...
				<legend>供应商信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%">
					    <input name='googid' type="text" class="text"style="width:154px"  />
				        </td>
				        	
					    <td nowrap align="right" width="18%" class="STYLE4">供应商名称:</td>
					    <td width="35%"><textarea name="gonggname" cols="30" rows="1" id="gonggname"></textarea>
					    <span id="yingname1" class="STYLE4"></span>
					    </td>
					    </tr>
						<tr>
					    <td nowrap align="right" width="18%" class="STYLE4">地址:</td>
					     <td width="35%" class="STYLE4"><input id="katime" name='dizhi' type="text" style="width:154px" />
					     <span id="yingtime1" class="STYLE4"></span>
					     </td>	
					     <td nowrap align="right" width="15%" class="STYLE4">联系人:</td>
					        <td width="35%" class="STYLE4"><input name='lianxiren' type="text" id="yingfuname" class="text"style="width:154px"  />
					        <span id="yingfuname1" class="STYLE4"></span>
					        </td>
						</tr>
						<tr>	
						    <td nowrap align="right" width="18%" class="STYLE4">联系人电话:</td>
							<td width="35%" class="STYLE4"><input name='liaophone' type="text" id="yinglianxi" class="text"style="width:154px"  />
							<span id="yinglianxi1" class="STYLE4"></span>
							</td>
							<td height="23" align="right" nowrap class="STYLE4">银行:</td>
						  <td><span class="STYLE4">
						    <input name='yinhang' type="text" id="yingrenshu"  class="text"style="width:154px" />
						  </span>
						...
						<tr>	
							...
							<td width="35%" class="STYLE4"><input name='yinhangid' type="text" id="yinhangid" class="text"style="width:154px"  />
							<span id="yinglianxi1" class="STYLE4"></span>
							</td>
						</tr>
					  </table>

...
<body>
<span class="STYLE4">当前页为：添加采购单信息页</span>
			...
			<TD width="100%" height="300">
				...
				<legend>采购单信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%">
					    <input name='caigou.caigouid' type="text" class="text"style="width:154px"  />
				        </td>
					    <td nowrap align="right" width="18%" class="STYLE4">供应商编号:</td>
					    <td width="35%">
					    <input name='caigou.gongid' type="text" class="text"style="width:154px"  />
					    </td>
					    </tr>
						<tr>
					    <td nowrap align="right" width="15%" class="STYLE4">物料编号:</td>
					    <td width="35%">
					    <input name='caigou.wuliaoid' type="text" class="text"style="width:154px"  />
					     </td>
					    <td nowrap align="right" width="18%" class="STYLE4">数量:</td>
					    <td width="35%">
					    <input name='caigou.shouliang' type="text" class="text"style="width:154px"  />
					     </td>	
						</tr>
						<tr>	
							<td nowrap align="right" width="15%" class="STYLE4">金额:</td>
							<td width="35%">
					        <input name='caigou.jine' type="text" class="text"style="width:154px"  />
					        <span class="STYLE4">元</span>
					        </td>
						    <td nowrap align="right" width="18%" class="STYLE4">采购时间:</td>
							<td width="35%" class="STYLE4"><input id="yingtime" name='caigou.caitime' type="text" onClick="WdatePicker()" style="width:154px" />

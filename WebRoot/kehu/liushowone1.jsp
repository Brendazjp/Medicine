...
<body>
<span class="STYLE4">当前页为：流失客户详细信息页</span>
<form action="liuke!update.action" method="post">
				...
				<legend>客户信息</legend>
					  ...
					  <tr>
					   ...
					   <tr>	
						...
						<tr>
						  <td height="111" align="right" nowrap class="STYLE4"> 流失时间:</td>
						  <td><input name='kehu.liutime' type="text" onClick="WdatePicker()"  style="width:154px" value="${kehu.liutime }" /></td>
						  <td nowrap="nowrap" align="right" class="STYLE4">流失原因:</td>
						  <td><textarea name="kehu.liuyuanyin" cols="45" rows="6" id="textare" >${kehu.liuyuanyin }</textarea></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>

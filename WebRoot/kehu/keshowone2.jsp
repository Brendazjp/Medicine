...
<body>
<span class="STYLE4">当前页为：执行客户流失信息页</span>
...
<table width="99%" border="0" cellpadding="0" cellspacing="0">    
				...
				<legend>客户信息</legend>
					  ...
					  <tr>
					   ...
					   <tr>	
						...
						<tr>
						  <td height="98" align="right" nowrap class="STYLE4">流失时间:</td>
						  ...
						  <td><textarea name="kehu.liuyuanyin" cols="45" rows="6" id="textare"></textarea></td>
						</tr>
		...
		<TR>
		  <TD colspan="2" align="center" height="50px">
			<input type="submit" value="执行流失" onclick="update();"/>

					  ...
					  <tr>
					   ...
					   <tr>	
						...
						<tr>
						  ...
						  <td><input name='kehu.liutime' type="text" class="text" readonly="readonly" style="width:154px" value="${kehu.liutime }" /></td>
						  <td nowrap="nowrap" align="right" class="STYLE4">流失原因:</td>
						  <td><textarea name="kehu.liuyuanyin" cols="45" rows="6" id="textare" readonly="readonly">${kehu.liuyuanyin }</textarea></td>
					    </tr>
					  </table>
				</fieldset>			
			</TD>
